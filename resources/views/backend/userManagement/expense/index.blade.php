		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<ul class="nav nav-tabs">
                    ...
                    <li class="all_leave"><a href="{{url('/admin/user/expense/add')}}" data-toggle="tab" aria-expanded="false">Add New</a>
                        </li>
                </ul>
							...
							<table class="table mb-0" id="carrier_table">
                                ...
                                @foreach ($data as $key => $user)
                                    ...
                                    <tr>
                                        ...
                                        <td class="copy-text">{{ $userdata }}</td>
                                        <td class="copy-text"> {{ $userStatus }}</td>
                                        <td class="action action_tooltip">
										    <a href="{{ url('admin/user/expense/view'.'/'.$user->id) }}"> 
											...
											<a href="{{ url('admin/user/expense/edit'.'/'.$user->id) }}" class="btn btn-outline-secondary btn-sm radius-30 px-4"> <i class="bx bx-edit"></i> <span class="tooltip">Edit</span></a>

                                            <a href="{{ url('/admin/user/expense/delete'.'/'.$user->id) }}" class="btn btn-outline-danger btn-sm radius-30 px-4"  title="Delete Credential"><i class="bx bx-trash"></i><span class="tooltip">Delete</span>
                                            </a>  
