<?php 
    if(isset($details)){
        ...
        $title = 'Add';
        $form_id = 'ExpenseForm';
        $action  =  url('/admin/user/expense/detail/add'.'/'.$id);
    }
?>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="user_id" id="user_id" class="form-control" required>
                                                ...
                                                @foreach ($users as $user)
                                                 <option value="{{ $user->id }}" {{ $user->id == $id ? 'selected' : '' }} disabled>{{ $user->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" id="expens_id" name="expens_id" placeholder="" value="{{$assigntl->assign_tl ?? "" }}" required>
                                        </div>
                                    </div>
                                    @endforeach
