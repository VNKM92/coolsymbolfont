        ...
        <div class="page-wrapper">
			<div class="page-content">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="all_leave active"><a href="{{url('/admin/user/expense/edit').'/'.$id}}" data-toggle="tab" aria-expanded="false">{{ $title }} New</a>
                        </li>
                </ul>
						...
						<div class="card border-primary">
							<div class="card-body p-3 col-xl-9 mx-auto">
								<div class="card-title d-flex align-items-center pb-2">
									...
									<h5 class="mb-0 text-primary ">{{ $title }} User</h5>
								</div>
								<!-- <hr> -->
								<div class="row g-3">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ $expdata->name }}" minlength="2" maxlength="30" >
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <strong>Email: <span class="text text-danger required">*</span></strong>
                                             <input type="email" class="form-control" id="email" name="email" value="{{ $expdata->email }}" placeholder="Email" minlength="2" maxlength="60" >
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="role" id="" class="form-control" required>
                                                ...
                                                <option value="2" @if($expdata->role == 2 ) selected @endif>Agent</option>
                                                <option value="1" @if($expdata->role == 1 ) selected @endif>Team Leader</option> 
                                                {{-- //Team Leader == 1 --}}
                                                {{-- //Agent == 2 --}}
                                            </select>
                                        </div>
                                     ...
                                     <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" value="{{ $expdata->phone }}" name="phone" placeholder="phone" value="" >
                                        </div>
                                    </div>
