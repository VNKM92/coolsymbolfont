...
@section('title','Assing User Team')
@section('content')
							...
							<div class="card-body p-3 col-xl-9 mx-auto">
                                ...
                                <form action="{{url('admin/assignuser/edit'.'/'.$userdata->id)}}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <strong>Vonage No. : <span class="text text-danger required">*</span></strong>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <strong>Manager List New: <span class="text text-danger required">*</span></strong>
                                                    ...
                                                    @foreach ($aginfo as $agdata)
                                                        <?php
                                                            ...
                                                            $uiddata = $userdata->assignto_id ;
                                                                    ...
                                                                    $agid = App\Models\User::get();
                                                                foreach ($agid as $userd):
                                                                        if($userd->user_type == 'officer' && $userd->status == '1'){
                                                                            ?>
                                                                            <option value="{{ $userd->id }}"
                                                                                 <?php echo ($userd->id == $uiddata ) ? 'selected="selected"' : '';?>
                                                                                > {{ $userd->name .' ' . $userd->officerid }}</option>
                                                                            <?php
                                                                        }
                                                                endforeach ;
                                                            //dd($agid);
