    ...
    <div class="page-wrapper">
		<div class="page-content">
			...
			<ul class="nav nav-tabs">
                ...
                <li class="all_leave active"><a href="javascript:void(0);" data-toggle="tab" aria-expanded="false">Setting</a></li>
            </ul>
                                            ...
                                            <table class="table" id="example">
                                                <thead class="table-light">
                                                    ...
                                                    @php
                                                        ...
                                                        $i = 0;
                                                    @endphp
                                                    {{-- $iplists = App\Models\IpChecker::orderBy('id', 'desc')->paginate(15); --}}
                                                    @foreach($iplists as $iplist)
                                                        <?php 
                                                            // $encoded_id = base64_encode($user['id']);
                                                            $encoded_id = base64_encode($iplist->id);   //$encoded_id = $user['id'];
                                        ...
                                        <div class="tab-pane container fade" id="unauthorized">
                                            <table class="table" id="example2">
                                                <thead class="table-light">
                                                    ...
                                                    @php
                                                        $authorizeusers = App\Models\AuthorizeIpChecker::orderBy('id', 'desc')->paginate(15);
                                                        //echo $iplist;
                                                        $i = 0;
