        ...
        <div class="page-content">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="pending_approval "><a href="{{ url('/admin/setting/dat/user/api') }}" data-toggle="tab"
                        aria-expanded="true">All Users</a>
                </li>


                <li class="pending_approval active"><a href="{{ url('/admin/setting/dat/show/admin') }}" data-toggle="tab"
                        aria-expanded="true">Real DAT User</a>
                </li>

                <li class="pending_approval "><a href="{{ url('/admin/setting/dat/show/self') }}" data-toggle="tab" aria-expanded="false">Activated DAT User</a>
                </li>
                            ...
                            <table class="table mb-0" id="carrier_table">
                                ...
                                <tbody id="user_data">
                                    ...
                                    @foreach ($Userdata as $user)
                                        ...
                                        @php
                                            $uid = $user->user_id ;
                                            $userNameinfo = App\Models\User::where('id', $uid)->first();
                                            // dd($userNameinfo);
                                        @endphp
                                    <tr>
                                        <td class="copy-text">{{ $userNameinfo->name }}</td>
                                        <td class="copy-text">{{ $userNameinfo->email }}</td>
                                        @php
                                            $userid = $user->user_id;
									...
									@endphp
                                        ...
                                        <td class="action action_tooltip">
                                            ...
                                            <!--    <button onclick="return confirm('Are You Sure Delete This Record..!')"-->
                                            <!--        class="btn btn-outline-danger btn-sm radius-30 px-4" type="submit"><i-->
                                            <!--            class="bx bx-trash"></i><span-->
                                            <!--            class="tooltip">Delete</span></button>-->
                                            <!--</form>-->

                                            <a href="{{url('/admin/setting/dat/rdelete').'/'.$encoded_id}}" class="btn btn-danger btn-sm radius-30 px-4" onclick="return confirm('Are You Sure Delete This Record..! ')">
