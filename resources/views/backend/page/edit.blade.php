...
<div class="page-wrapper">
			<div class="page-content">
				...
				<ul class="nav nav-tabs">
                    @can('shipper-all')
                    <!-- <li class="pending_approval"><a href="{{url('/admin/page/list')}}" data-toggle="tab" aria-expanded="true">All page</a></li> -->
                    @endcan
                ...
                @endif
                        ...
                        <div class="card">
        					<div class="card-body">
        						<form class="form-horizontal" method="post" action="{{url('admin/page/edit').'/'.$id}}" id="user_form" enctype="multipart/form-data">
                                    @csrf
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            @php
                                                $imag ="";
                                                    if(!empty($data->image)){
                                                        $imag = url('public/backend/movie/page').'/'.$data->image ;
                                                    }else {
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <img src="{{ $imag }}" alt="{{ $data->title }}" height="200px" >
