...
<div class="page-wrapper">
			<div class="page-content">
                ...
                @endif
                        ...
                        <div class="card">
        					<div class="card-body">
        						<form class="form-horizontal" method="post" action="{{url('admin/blog/edit').'/'.$id}}" id="user_form" enctype="multipart/form-data">
                                    @csrf
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                 ...
                                                 <div style="border:1px solid gray; hight:300px ; width:400px; overflow: hidden;">
                                                    <img src="{{ $imag }}" class="img-fluid"  alt="{{ $data->title }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" id="editor1" class="editor1" style="color:black" >{{ $data->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
