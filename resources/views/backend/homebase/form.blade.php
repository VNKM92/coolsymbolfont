            ...
            @endif
                ...
                <div class="page-content">
                        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        					<div class="breadcrumb-title pe-3">Home Add</div>
        					<div class="ps-3">
                        ...
                        <div class="card">
        					<div class="card-body">
        						<form class="form-horizontal" method="post" action="{{url('admin/homebase/add')}}" id="user_form" enctype="multipart/form-data">
                                    @csrf
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">miancontent</label>
                                                    <textarea name="miancontent" id="editor1" class="editor1" style="color:black" ></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">subcontent</label>
                                                    <textarea name="subcontent" id="editor1" class="editor1" style="color:black" ></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">adshow</label>
                                                    <textarea name="adshow" id="editor1" class="editor1" style="color:black" ></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="">anyvideo</label>
                                                    <input type="text" name="anyvideo" value="" class="form-control" placeholder="300x300px">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                   ...
                                                   <label for="url">Any URL Video</label>
                                                    <input type="text" name="url" value="" class="form-control" placeholder="300x300px">
                                                </div>
                                                </div>
                                            </div>
                                        </div>
