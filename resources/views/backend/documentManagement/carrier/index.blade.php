						...
						<thead class="table-light">
							...
							<tr>
								...
								<td>{{ $item->document }}
                                    ...
                                    <a href="{{ asset('public/backend/carrierdocument/'.$doc->document)}}" download="{{ $item->document }}"> 
								...
								<td class="action_tooltip">
	                                 @php
                                    	...
                                    	$agencyid = $item->id;
                                    @endphp
                                    <a class="btn btn-outline-info btn-sm radius-30 px-4" href="{{url('admin/carrier/doc/upload/data/view').'/'.$agencyid }}"> <i class="bx bx-show"></i> <span class="tooltip">View</span></a>
                                    @can('report')
