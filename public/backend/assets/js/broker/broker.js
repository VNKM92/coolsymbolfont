...
else var HOSTPATH = "http://localhost/amb/";
...
$(document).on("click", "#carrier_search", function () {
    ...
    if (carrier_name != "" || carrier_mc != "" || carrier_dot != "") {
        ...
        $.ajax({
            url: HOSTPATH + "admin/carriers-find",
            type: "get",
            cache: false,
            dataType: "json",
            data: {
            ...
            success: function (data) {
                ...
                if (data != "") {
                    ...
                    $.ajax({
                        url: HOSTPATH + "admin/carrier/add-carrier-form",
                        type: "get",
                        cache: false,
                        data: {
                            carrier_name: carrier_name,
...
$(document).on("change", "#shipper_name", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipper/ShipperNameCheck",
        type: "get",
        cache: false,
        dataType: "json",
...
$(document).on("change", "#shipper_name_testamb", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/GetShipperDataShipment",
        type: "get",
        cache: false,
        dataType: "json",
        data: { shipper_name: shipper_name },
...
$(document).on("click", ".carrier_edit", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/carrier/carriers_edit",
        type: "get",
        cache: false,
...
$(document).on("click", ".agency_detail_form", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/agency/agency_details",
        type: "get",
        cache: false,
...
$(document).on("blur", "#shipment_mc", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/carrier_mc",
        type: "get",
        cache: false,
        dataType: "json",
...
$(document).on("blur", "#carrier_dot", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/carrier_dot",
        type: "get",
        cache: false,
        dataType: "json",
        data: { shipment_mc: shipment_mc },
...
$(document).on("click", "#Carrier_Doc_Del", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/shipment_doc_del",
        type: "get",
        cache: false,
...
$(document).on("keyup", "#lane_origin_input", function (e) {
    ...
    if (query != "") {
        $.ajax({
            url: HOSTPATH + "admin/load/GetLoadOriginData",
            type: "get",
            cache: false,
            data: { query: query },
            success: function (data) {
...
$(document).on("click", "#load_refresh_btn", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/load/LoadAgeRefresh",
        type: "get",
        cache: false,
        data: { datId: datId },
        success: function (data) {
...
$(document).on("click", "#load_repost_btn", function () {
    ...
    if (result == true) {
        ...
        var datId = dat_id.val();
        $.ajax({
            url: HOSTPATH + "admin/load/repost",
            type: "get",
            cache: false,
            data: { datId: datId },
            success: function (data) {
                window.location.href = HOSTPATH + "admin/loads";
            },
        });
    } else {
        return false;
...
$(document).on("click", "#load_delete_btn", function () {
    ...
    if (result == true) {
        ...
        var datId = dat_id.val();
        $.ajax({
            url: HOSTPATH + "admin/load/LoadPostDelete",
            type: "get",
            cache: false,
            data: { datId: datId },
            success: function (data) {
                ...
                if (data != "1") {
                    Swal.fire({
                        title: "Load Deleted!",
                        text: "Load deleted Unsuccessful, load can be deleted from DAT.",
                        icon: "warning",
                        confirmButtonText: "Ok",
                    });
...
$(document).on("click", "#load_delete_btn_New", function () {
    var result = confirm("Are You Sure Delete This Record..!");
    if (result == true) {
        var dat_id = $(this).parent().find("#load_dat_id");
        var datId = dat_id.val();

        console.log("Deleting load with datId:", datId);
        $.ajax({
            url: HOSTPATH + "admin/load/LoadPostDelete",
            type: "get",
            cache: false,
            ...
            success: function (data) {
                console.log(
                    "AJAX request successful. Received data:",
                    data.status
                );
                console.log(data);
                if (data === "1") {
                    ...
                    Swal.fire({
                        title: "Load Not Deleted!",
                        text: "Load deleted Unsuccessful,Regenerate token and try again!",
                        icon: "error",
                        confirmButtonText: "Ok",
                    });
                }
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                ...
                console.log("Received response:", jqXHR.responseText);
                Swal.fire({
                    title: "Error!",
                    text: "An error occurred during the deletion process. Please try again later.",
                    icon: "error",
                    confirmButtonText: "Ok",
                });
            },
...
$(document).on("click", "#load_update_form_btn", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/load/LodePostUpdateForm",
        type: "get",
        cache: false,
        data: { datId: datId },
        success: function (data) {
...
$(document).on("click", "#LoadPostRateBtn", function (e) {
    ...
    var equipment_type = $("#equipment_type").find(":selected").text();
    ...
    $.ajax({
        url: HOSTPATH + "admin/load/LoadPostRateView",
        method: "POST",
        data: {
            origin: origin,
...
/* Broker Dat load retaview funcation Start Here */
$(document).on("click", ".request_update_Old", function (e) {
    ...
    if ((comment != "" && limit != "") || prepay != "") {
        $.ajax({
            url: HOSTPATH + "admin/shipper/request_update",
            method: "POST",
            data: {
            ...
            success: function (data) {
                setTimeout(function () {
                    window.location.href = HOSTPATH + "admin/shipper/request";
                    //location.reload(true);
                }, 500);
            },
        });
...
$(document).on("click", ".request_update", function (e) {
    ...
    var limit = $("#limit").val();
    var prepay = $("#prepay_limit").val();
    var titlecompany = $("#encode_title").val();
    var assigntoid = $("#assigntoid").val();
    var payment_terms = $("#payment_terms").val();
    var shipper_prepaid = $("#shipper_prepaid").val();
    ...
    if (
        ...
        if (assigntoid.trim() === "") {
            $("#assigntoiderror").text("Please select a user.");
        } else {
            $("#assigntoiderror").text("");
        }
    ...
    if (paymentType === "prepay" && shipper_prepaid !== "1") {
        alert(
            'Invalid selection. Prepaid status should be "Active Prepaid" for Prepay payment type.'
        );
        return;
    }
    if (paymentType === "limit" && shipper_prepaid !== "0") {
        alert(
            'Invalid selection. Prepaid status should be "Active Limit" for Limit payment type.'
        );
        return;
    }

    if ((comment != "" && limit != "") || prepay != "" || assigntoid != "") {
        console.log(comment);
        $.ajax({
            url: HOSTPATH + "admin/shipper/request_update",
            method: "POST",
            data: {
                shipper_prepaid: shipper_prepaid,
                companies_id: companies_id,
                status: status,
                comment: comment,
                limit: limit,
            ...
            success: function (data) {
                setTimeout(function () {
                    ...
                    // window.location.href = HOSTPATH+'admin/shipper/request/edit/'+base64_encode(companies_id);
                    // window.location.href = HOSTPATH+'admin/shipper/request/edit/';
                    location.reload(true);
                }, 500);
            },
        });
...
$(document).on("click", ".request_update_New_eror", function (e) {
    e.preventDefault();
    var companies_id = $("#companies_id").val();
    var status = $(this).val();
    var comment = $("#comment").val();
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status === "success") {
                ...
                alert(
                    "Something went wrong!! Failed to update. Please try again."
                );
            }
        },
...
$(document).on("change", "#shipment_status_change", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/ShipmentStatusUpdate",
        method: "GET",
...
$(document).on("click", "#btnSearchDotNumber", function (e) {
    ...
    if (DotNumber != "") {
        ...
        $.ajax({
            url: HOSTPATH + "admin/carrier/PreviewCarrierDetail",
            method: "get",
...
$(document).on("click", "#EmailInvite", function (e) {
    ...
    $.ajax({
        url: HOSTPATH + "admin/carrier/CarrierEmailInviteForm",
        method: "get",
        data: { DotNumber: DotNumber, DocketNumber: DocketNumber },
        cache: false,
        success: function (data) {
...
$(document).on("click", "#EmailInviteSent", function (e) {
    ...
    if (verify_emails != "") {
        ...
        $.ajax({
            url: HOSTPATH + "admin/carrier-packet/EmailInviteSent",
            method: "get",
            data: {
                verify_emails: verify_emails,
                emails_sent_by: emails_sent_by,
            },
            cache: false,
            success: function (data) {
...
$(document).on("click", "#ShipmentRefreshAdmin", function () {
    ...
    if (
        ...
        $.ajax({
            url: HOSTPATH + "admin/shipment/AllShipmentFilterAdmin",
            type: "get",
            cache: false,
            data: {
...
$(document).on("click", "#ShipmentRefreshB", function () {
    ...
    if (
        ...
        $.ajax({
            url: HOSTPATH + "admin/shipment/ShipmentFilterAdmin",
            type: "get",
            cache: false,
            data: {
                ShipmentStatus: ShipmentStatus,
...
$(document).on("click", "#ShipperRefreshB", function () {
    ...
    if (ShipperStatus != "" || ShipperName != "" || AgentName != "") {
        $.ajax({
            url: HOSTPATH + "admin/shipper/ShipperFilterAdmin",
            type: "get",
            cache: false,
            data: {
...
$(document).on("click", "#btnPickDropFrom", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/PicksDropsForm",
        type: "get",
        cache: false,
...
$(document).on("click", "#AddExtraPick", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/AddExtraPick",
        method: "GET",
...
$(document).on("click", "#shipment_drop_save", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/ExtraDropSubmit",
        method: "POST",
        data: {
            drop_id: drop_id,
            d_name: d_name,
        ...
        success: function (data) {
            $("#shipment_drop_save")
                .closest("form")
                .find("[name=drop_msg]")
                .text("Drop details update successfully!");
        },
    });
});
...
$(document).on("click", "#AddExtraDrop", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/AddExtraDrop",
        method: "GET",
        data: { ManagePick_id: ManagePick_id },
        cache: false,
        success: function (data) {
...
$(document).on("click", "#shipment_pick_save", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/ExtraPickSubmit",
        method: "POST",
        data: {
            pick_id: pick_id,
            p_name: p_name,
        ...
        success: function (data) {
            $("#shipment_pick_save")
                .closest("form")
                .find("[name=pick_msg]")
                .text("Pick details update successfully!");
        },
    });
});
...
$(document).on("click", "#shipment_pick_delete", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/DeleteExtraPick",
        method: "GET",
...
$(document).on("click", "#shipment_drop_delete", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/shipment/DeleteExtraDrop",
        method: "GET",
...
$(document).on("click", ".GetTruckResult", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/load/TruckExactResult",
        method: "GET",
...
$(document).on("click", "#TruckSearchDelete", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/load/TruckSearchDelete",
        method: "GET",
...
$(document).on("click", "#ApfillterRefreshB", function () {
    ...
    if (ApStatus != "" || ShipperName != "" || AgentName != "") {
        $.ajax({
            url: HOSTPATH + "admin/accountap/fillter/",
            type: "get",
            cache: false,
...
$(document).on("click", "#EmailSubmitBtn", function () {
    ...
    $.ajax({
        ...
        data: {
            ...
            ar_invoice_gen: ar_invoice_gen,
        },
        success: function (data) {
            setTimeout(function () {
                window.location.href =
                    HOSTPATH + "admin/ar/shipment-detail/" + company_id;
            }, 500);
        },
    });
});
...
$(document).on("click", ".apshipupload_fetch", function () {
    ...
    //ShowLoaderTimeLine();
    $.ajax({
        url: HOSTPATH + "admin/apcomment/apdocumentfetch",
        type: "get",
        cache: false,
        data: { carrier_id: carrier_id },
        success: function (data) {
...
$(document).on("click", "#PaymentUpdateOld", function () {
    var shipmentId = $(this).parent().find("#shipment_id");
    var shipment_id = shipmentId.val();

    $.ajax({
        url: HOSTPATH + "admin/ar/PaymentUpdateForm",
        type: "get",
        cache: false,
        data: { shipment_id: shipment_id },
        success: function (data) {
...
$(document).on("click", "#PaymentUpdate", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#ArPaymentUpt").on("shown.bs.modal", function () {
                ...
                function calculateBalanceDue() {
                    const invoiceAmount =
                        parseFloat(invoiceAmountInput.value) || 0;
                    const amountPaid = parseFloat(amountPaidInput.value) || 0;
                    const balanceDue = invoiceAmount - amountPaid;
                    balanceDueInput.value = balanceDue.toFixed(2); // Set balance due with two decimal places
                }

                invoiceAmountInput.addEventListener(
                    "input",
                    calculateBalanceDue
                );
...
$(document).on("click", "#PaymentUpdateAP", function () {
    var shipmentId = $(this).parent().find("#shipment_id");
    var shipment_id = shipmentId.val();
    $.ajax({
        url: HOSTPATH + "admin/ap/PaymentUpdateForm",
        type: "get",
        cache: false,
        data: { shipment_id: shipment_id },
        success: function (data) {
            $("#ApPaymentUpt").html(data);

            $("#ApPaymentUpt").on('shown.bs.modal', function () {
                ...
                invoiceAmountInput.addEventListener('input', calculateBalanceDue);
                amountPaidInput.addEventListener('input', calculateBalanceDue);
                calculateBalanceDue();
            });
            ...
            setTimeout(function () {
                $("#ApPaymentUpt").modal("show");
            }, 500);
        },
    });
});

$(document).on("click", "#ApPaymentFormBtn", function () {
    ...
    // console.log(shipment_id,pro_num,pay_mode,invoice_amount,amount_paid,balance_due,received_date);
    ...
    if (
        ...
        if (shipment_id != "") {
            $.ajax({
                url: HOSTPATH + "admin/ap/PaymentUpdateSubmit",
                type: "get",
                cache: false,
                data: {
        ...
        if (invoice_amount.length == "") {
            $("#invoiceAmountError").text("Please Enter Invoiced Amount!");
            return false;
        } else {
            $("#invoiceAmountError").hide();
        }
        ...
        if (amount_paid.length == "") {
            $("#amountPaidError").text("Please Enter Received Amount!");
            return false;
        } else {
            $("#amountPaidError").hide();
        }
        if (balance_due.length == "") {
            $("#balanceDueError").text("Please Enter Balance Due!");
            return false;
        } else {
            $("#balanceDueError").hide();
        }
        if (received_date.length == "") {
            $("#receivedDateError").text("Select Received Date!");
            return false;
        } else {
            $("#receivedDateError").hide();
        }
        ...
        if (settle_amount.length == "") {
            $("#settle_error").text("Please Enter Settle Amount!");
            return false;
        } else {
            $("#settle_error").hide();
        }
...
$(document).on("click", "#ArPaymentFormBtn", function () {
    ...
    if (
        ...
        if (received_date.length == "") {
            $("#receivedDateError").text("Select Receiveddsa Date!");
            return false;
        } else {
            $("#receivedDateError").hide();
        }
...
$(document).on("click", "#ArCommentForm", function () {
    ...
    //ShowLoaderTimeLine();
    $.ajax({
        url: HOSTPATH + "admin/ar/Payment-Comment",
        type: "get",
        cache: false,
        data: { carrier_id: carrier_id },
        success: function (data) {
...
$(document).on("click", "#ArCommentSubmit", function () {
    ...
    //ShowLoaderTimeLine();
    $.ajax({
        url: HOSTPATH + "admin/ar/Payment-CommentSubmit",
        type: "get",
        cache: false,
        data: {
...
$("#referenc").keypress(function (e) {
    if (e.which == 13) {
        ...
        if (referenc != "") {
            ...
            $.ajax({
                url: HOSTPATH + "admin/load/ReferencSearch",
                type: "get",
                cache: false,
...
/* Load referenc find function Start here*/
// $(document).on('blur','#referencx', function(){
// 	var referenc = $(this).val();
// 	if(referenc != ''){
// 	//ShowLoaderTimeLine();
// 		$.ajax({
...
$(document).on("blur", "#NewShipmentAdd", function () {
    var load_id = $("load_dat_id").val();
    $.ajax({
        url: HOSTPATH + "admin/shipment/NewShipmentadd",
        type: "get",
        cache: false,
        data: { load_id: load_id },
        success: function (data) {},
...
$(document).on("blur", "#NewShipmentCreate", function () {
    var load_id = $("#load_dat_id").val();
    $.ajax({
        url: HOSTPATH + "admin/shipment/NewShipmentCreate",
        type: "get",
        cache: false,
        data: { load_id: load_id },
        success: function (data) {},
...
$(document).on("click", "#loadCommentBtn", function (e) {
    ...
    if (loadComment != "") {
        ...
        $.ajax({
            url: HOSTPATH + "admin/load/newCommentAdd",
            method: "get",
...
$(document).on("blur", "#CarrierRequestBtn", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/carrier/CarrierRequestForm",
        type: "get",
        cache: false,
        data: { carrier_id: carrier_id },
        success: function (data) {
...
$(document).on("click", "#notification_col", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/notification/read/",
        type: "get",
        cache: false,
        data: { id: id },
        success: function (data) {
...
$(document).on("click", "#loadComment_col", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/load/ReferencSearchUpdate",
        type: "get",
        cache: false,
        data: { referenc: referenc },
        success: function (data) {
...
$(document).on("click", "#CarrierRequest_col", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/carrier/request/commentform",
        type: "get",
        cache: false,
        data: { carrier_id: carrier_id },
        success: function (data) {
...
$(document).on("click", "#requestCommentBtn", function () {
    ...
    $.ajax({
        url: HOSTPATH + "admin/carrier/request/commentUpdate",
        type: "get",
        cache: false,
...
$(document).on("click", "#AllReadNotification", function () {
    ...
    if (result == true) {
        $.ajax({
            url: HOSTPATH + "admin/notification/read/all",
            type: "get",
            cache: false,
            data: { carrier_id: carrier_id },
            success: function (data) {
...
$(document).on("click", "#AllReadMessageNotification", function () {
    ...
    if (result == true) {
        $.ajax({
            url: HOSTPATH + "admin/notification/message/read/all",
            type: "get",
            cache: false,
            data: { carrier_id: carrier_id },
            success: function (data) {
...
$(document).on("click", "#ShipperRequest_col", function () {
    var id = $(this).attr("value");
    $.ajax({
        url: HOSTPATH + "admin/shipper/requset/commentform",
        type: "get",
        cache: false,
        data: { id: id },
        success: function (data) {
...
$(document).on("click", "#agencyManager", function () {
    ...
    //return false;
    $.ajax({
        url: HOSTPATH + "admin/agency/new/office/" + id,
        type: "get",
        cache: false,
        data: { id: id },
        success: function (data) {
...
$(document).on("click", "#ship_activity_detail", function () {
    ...
    //return false;
    $.ajax({
        url: HOSTPATH + "admin/load-activity/details/" + id,
        type: "get",
        cache: false,
        data: { id: id },
        success: function (data) {
...
$(document).on("click", "#ShipperCommentBtn", function () {
    ...
    if (comment != "") {
        $.ajax({
            url: HOSTPATH + "admin/shipper/requset/commentUpdate",
            type: "get",
            cache: false,
...
$(document).on("click", "#quickpay_request", function () {
    ...
    if (result == true) {
        ...
        $.ajax({
            url: HOSTPATH + "admin/carrier/payment/quickpay",
            type: "get",
            cache: false,
            data: {
                shipment_id: shipment_id,
                pay_deduct: pay_deduct,
                quickpay_amount: quickpay_amount,
            },
            success: function (data) {
                if (data == 1) {
                    location.reload(true);
...
$(document).click(function (e) {
    if ($(e.target).closest(".action_bar").length === 0) {
        $(".action_bar").removeClass("action_action");
    }
});
